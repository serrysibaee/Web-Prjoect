...
function emptyInputSignup($email, $pass, $uname, $phone)
{
    $result = true;
...
{
    $userNameAlreadyExist = existUsername($conn, $email, $email);
    ...
    $hashPass = $userNameAlreadyExist["password"];
    $checkPassword = password_verify($pass, $hashPass);
    ...
    if ($checkPassword === false) {
        ...
        session_start();
        $_SESSION["userid"] = $userNameAlreadyExist["id"];
        $_SESSION["username"] = $userNameAlreadyExist["username"];
